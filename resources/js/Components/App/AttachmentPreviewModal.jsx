...
export default function AttachmentPreviewModal({
    ...
    }, [currentIndex, previewableAttachments.length]);
    useEffect(() => {
                        ...
                        <Transition.Child
                            ...
                            <Dialog.Panel
                                ...
                                <div className="relative group h-full ">
                                    ...
                                    cursor-pointer flex items-center justify-center w-16 h-16 left-4 top-1/2 -translate-y-1/2
                                    ...
                                    {currentIndex < previewableAttachments.length - 1 && (
                                        <div onClick={next}
                                             ...
                                             justify-center w-16 h-16 right-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 z-30">
                                    ...
                                    {attachment && (
                                        <div className="flex items-center justify-center w-full h-full p-3">
                                            {isImage(attachment) && (
                                                <img alt="" src={attachment.url} className="max-w-full max-h-full"/>
                                            )}
                                            ...
                                            {!isPreviewable(attachment) && (
                                                <div
                                                    className="p-32 flex flex-col justify-center items-center text-gray-100">
